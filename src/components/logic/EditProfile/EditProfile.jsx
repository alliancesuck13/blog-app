  ...
  return (
    ...
    >
      <FormControl isRequired mb="8px">
        ...
        <Input id="username" mb="21px" type="text" value="john1snow" />
        <FormLabel htmlFor="email">Email address</FormLabel>
        <Input id="email" mb="21px" type="email" value="johnsnow@yummi.com" />
        <FormLabel htmlFor="password">New password</FormLabel>
        <Input id="password" mb="21px" type="password" placeholder="New password" />
